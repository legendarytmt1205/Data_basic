...
Create Table `db_furama`.type_rents (
...
Create Table `db_furama`.services (
...
Create Table `db_furama`.contracts (
...
Create Table `db_furama`.contract_details (
