...
insert into `db_furama`.employees(full_name,birthday,id_card,salary,phone_number,email, address,position_id, education_id, department_id)
values('Hoàng Văn Khanh','1990-01-24', '012312345', 7000000.00, '076121212', 'abc1@gamil.com', 'Quảng Trị',4 ,3 ,2 ),
...
insert into `db_furama`.type_customers(type_customer_name)
values ('Diamond'),('Platinium'),('Gold'),('Silver'),('Member');

insert into `db_furama`.customers(full_name,birthday,id_card,phone_number,email,address,type_customer_id)
...
insert into `db_furama`.type_rents(type_rent_name,price) 
values ('Năm',100000000.00),
('Tháng',15000000.00),('Ngày',1000000.00),('Gio',200000.00);

insert into `db_furama`.type_services(type_services_name) 
values ('Villa'),('House'),('Room');

insert into `db_furama`.services(service_status,service_name,area_used,number_floors,number_max_people,rental_costs,accompanied_service_status,type_rent_id,type_service_id)
...
insert into `db_furama`.accompanied_services(accompanied_service_name,price,unit,accompanied_service_status)
...
insert into `db_furama`.contracts(contract_date,contract_date_end,deposit,total,employee_id,customer_id,service_id)
...
insert into `db_furama`.contract_details(quantity,contract_id,accompanied_service_id)
